...
<html lang="en">
    <head>
        ...
        <title>Panel urgentiste - Dossier d'admission</title>
    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                <span class="site-heading-lower">Espace urgentiste</span>
            </h1>
        </header>
        <!-- Navbar-->
        <?php
                        ...
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                              <a href="/Projet_hopital/view/listepatients.php"/>Retour</a></p>
                                ...
                                <p class="text-center text-muted">La constitution du dossier d'admission permettra aux patients d'accéder aux différents services de l'établissement.
                                  Assurez-vous que vous fournissez bien les informations des patients afin qu'ils puissent être pris en charge.</p>
                                ...
                                <form action="../back/ajoutDossier.php" method="post">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <input type="number" class="form-control" name="prenom" value="id_patient" required>
                                    </div>
