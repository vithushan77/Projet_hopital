...
<html lang="en">
    ...
    <body>
        ...
        $manager = new manager();
        $specialites = $manager->afficherSpecialites();
        ?>
                            ...
                            <div class="bg-faded rounded p-5">
                              <a href="/Projet_hopital/view/panel_admin.php"/>Retour</a></p>
                                <h2 class="section-heading mb-4">
                                    <span class="section-heading-upper">Création d'un compte HSP pour les praticiens hospitaliers</span>
                                </h2>

                                <form action="../back/adminAddMedecins.php" method="post" >
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <select name="nomSpe" class="form-control" required>
                                          <?php foreach($specialites as $keys => $values) { ?>
                                           <option value="<?=$values['id']?>"><?=$values['nomSpe']?></option>
                                         <?php } ?>
                                        </select>
                                      </div>
